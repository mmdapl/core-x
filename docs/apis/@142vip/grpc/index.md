...
- [GrpcRequest](interfaces/GrpcRequest.md)
- [GrpcResponse](interfaces/GrpcResponse.md)
...
- [exampleProtoPackageName](variables/exampleProtoPackageName.md)
- [exampleProtoServiceName](variables/exampleProtoServiceName.md)
- [exampleProtoServicePath](variables/exampleProtoServicePath.md)
- [grpcExampleService](variables/grpcExampleService.md)
- [healthProto](variables/healthProto.md)
- [healthProtoPackageName](variables/healthProtoPackageName.md)
- [healthProtoServiceName](variables/healthProtoServiceName.md)
- [healthProtoServicePath](variables/healthProtoServicePath.md)
- [protos](variables/protos.md)
- [testProto](variables/testProto.md)
- [testProtoPackageName](variables/testProtoPackageName.md)
- [testProtoSimpleServiceName](variables/testProtoSimpleServiceName.md)
- [testProtoSimpleServicePath](variables/testProtoSimpleServicePath.md)
...
- [clientToServer](functions/clientToServer.md)
- [clientToServerStream](functions/clientToServerStream.md)
- [generateTraceId](functions/generateTraceId.md)
- [getMethodType](functions/getMethodType.md)
- [getSimpleGrpcClient](functions/getSimpleGrpcClient.md)
- [getStreamGrpcClient](functions/getStreamGrpcClient.md)
