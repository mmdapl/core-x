[API 参考](../../../packages.md) / [@142vip/utils](../index.md) / VipDocker

# 变量: VipDocker

> `const` **VipDocker**: `object`

定义于: [packages/utils/src/core/docker.ts:400](https://github.com/142vip/core-x/blob/293ce1057e8ca17514533d1e98d7acd05ef45b34/packages/utils/src/core/docker.ts#L400)
