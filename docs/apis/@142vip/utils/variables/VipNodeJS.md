[API 参考](../../../packages.md) / [@142vip/utils](../index.md) / VipNodeJS

# 变量: VipNodeJS

> `const` **VipNodeJS**: `object`

定义于: [packages/utils/src/core/nodejs.ts:240](https://github.com/142vip/core-x/blob/293ce1057e8ca17514533d1e98d7acd05ef45b34/packages/utils/src/core/nodejs.ts#L240)
