[API 参考](../../../packages.md) / [@142vip/utils](../index.md) / VipNpm

# 变量: VipNpm

> `const` **VipNpm**: `object`

定义于: [packages/utils/src/core/npm.ts:162](https://github.com/142vip/core-x/blob/293ce1057e8ca17514533d1e98d7acd05ef45b34/packages/utils/src/core/npm.ts#L162)
